...
The objective of this project is to analyze the Walmart Sales data in order to identify the best-performing branches and products, sales trends of different products, and customer behavior. The goal is to study how sales strategies can be improved and optimized. The dataset was obtained from Walmart.[Kaggle Walmart Sales Forecasting Competition](https://www.kaggle.com/c/walmart-recruiting-store-sales-forecasting).
...
For the rest of the code, check the [SQL Queries for Walmart Data Analysis.sql](https://github.com/Saurav-paul98/Walmart-Data-Analysis-With-SQL/blob/main/SQL%20Queries%20for%20Walmart%20Data%20Analysis.sql) file
